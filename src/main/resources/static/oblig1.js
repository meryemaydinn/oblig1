...
function BillettBestilling (){
  ...
  let film = document.getElementById('film').value;
    ...
    if ((antall == null) || (antall == '')) {
        let ut = 'Må skrive noe inn i antall';
    ...
    if ((name == null) || (name == '')){
        let ut = 'Må skrive noe inn i fornavnet';
    ...
    if ((surname == null) || (surname == '')) {
        let ut = 'Må skirve noe inn i fornavnet';
    ...
    if ((phone == null) || (phone == '')) {
        let ut = 'Må skrive noe inn i telefonnr';
    ...
    if ((email == null) || (email == '')) {
        let ut = 'Må skrive noe inn i epost';
